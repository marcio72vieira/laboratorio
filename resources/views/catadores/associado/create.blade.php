...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h5 mb-4 text-gray-800"><strong>Catadores / Associados / cadastro</strong></h1>
        ...
        <div class="col-lg-12 order-lg-1">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('admincat.associado.store')}}" autocomplete="off">
                        @csrf
                        ...
                        <div class="pl-lg-4">
                            <div class="row">
                                <div class="col text-center">
                                    <a class="btn btn-primary" href="{{route('admincat.associado.index')}}" role="button">Cancelar</a>
